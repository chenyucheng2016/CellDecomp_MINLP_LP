...
%{
Update: 
1. added line instersecion detect for recObs
2. added line intersection detect for cirObs
...
function A = CTarget(targets,obstacles)
n = 80;  % # of step of sampling
myStart = 0;
myEnd = 9.2;
