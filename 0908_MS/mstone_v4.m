...
%{
Update: 
1. can calc EER of milestone
2. plot milestones grouped by EER value
3. soloved Overlapping C-target problem. Can see A, can't see B, but closer to B. 
...
global A2d
n = length(A2d);
numMS = 180;  % number of total milestone
w = 0.9;  % higher  less RBB
nUnif = round(numMS * w);
nRBB = numMS - nUnif;
sigma = round(n*0.08);
msRBB = [];   msUnif = [];
